...
fn http_spec() -> NodeType {
    NodeType {
        ...
        config: vec![
            ...
            ConfigFieldDef {
                name: "resource".into(),
                label: "Resource (id or {id, required_capability})".into(),
                ty: ConfigFieldType::String,
                default: None,
                required: false,
            },
            ConfigFieldDef {
                name: "path".into(),
                label: "Path (used when resource is set)".into(),
                ty: ConfigFieldType::String,
                default: None,
                required: false,
            },
            ConfigFieldDef {
                name: "origin".into(),
                label: "Origin (env or host)".into(),
                ty: ConfigFieldType::Select,
                default: Some(serde_json::json!(["env", "host"])),
                required: false,
            },
            ConfigFieldDef {
                name: "method".into(),
